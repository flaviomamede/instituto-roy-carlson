/* page-flip 2.0.7 — transpilado para ES5 (Babel) para rodar em Safari/Chrome antigos. Original ES6 quebrava o parse em iOS antigo. */
"use strict";
...
!function (t, e) {
  ...
  var i = /*#__PURE__*/function (_e2) {
    function i(t, e, _i) {
      ...
      _this = _callSuper(this, i, [t, _i]), _this.image = null, _this.isLoad = !1, _this.loadingAngle = 0, _this.image = new Image(), _this.image.src = e;
      return _this;
    }
    _inherits(i, _e2);
  ...
  var s = /*#__PURE__*/function () {
    ...
    return _createClass(s, [{
      ...
      value: function getSpreadIndexByPage(t) {
        ...
        for (var _i5 = 0; _i5 < e.length; _i5++) if (t === e[_i5][0] || t === e[_i5][1]) return _i5;
        return null;
      }
    }, {
      key: "getPageCount",
  ...
  var n = /*#__PURE__*/function (_s) {
    function n(t, e, i) {
      ...
      _this3 = _callSuper(this, n, [t, e]), _this3.imagesHref = i;
      return _this3;
    }
    _inherits(n, _s);
  ...
  var h = /*#__PURE__*/function () {
    ...
    return _createClass(h, null, [{
      ...
      value: function GetCordsFromTwoPoint(t, e) {
        ...
        for (var _o = 1; _o <= n; _o += 1) _h3.push({
          x: r(t.x, e.x, i, n, _o),
          y: r(t.y, e.y, s, n, _o)
        });
        return _h3;
  ...
  var r = /*#__PURE__*/function (_e5) {
    function r(t, e, i) {
      ...
      _this4 = _callSuper(this, r, [t, i]), _this4.copiedElement = null, _this4.temporaryCopy = null, _this4.isLoad = !1, _this4.element = e, _this4.element.classList.add("stf__item"), _this4.element.classList.add("--" + i);
      return _this4;
    }
    _inherits(r, _e5);
    return _createClass(r, [{
      ...
      key: "setOrientation",
      value: function setOrientation(t) {
        _superPropGet(r, "setOrientation", this, 3)([t]), this.element.classList.remove("--left", "--right"), this.element.classList.add(1 === t ? "--right" : "--left");
      }
    }, {
      key: "setDrawingDensity",
      value: function setDrawingDensity(t) {
        this.element.classList.remove("--soft", "--hard"), this.element.classList.add("--" + t), _superPropGet(r, "setDrawingDensity", this, 3)([t]);
      }
    }]);
  }(e);
  var o = /*#__PURE__*/function (_s2) {
    function o(t, e, i, s) {
      ...
      _this5 = _callSuper(this, o, [t, e]), _this5.element = i, _this5.pagesElement = s;
      return _this5;
    }
    _inherits(o, _s2);
  ...
  var g = /*#__PURE__*/function () {
    ...
    return _createClass(g, [{
      ...
      value: function checkState() {
        ...
        for (var _i8 = 0, _t0 = t; _i8 < _t0.length; _i8++) {
          var _e8 = _t0[_i8];
  ...
  var l = /*#__PURE__*/function () {
    ...
    return _createClass(l, [{
      ...
      value: function start() {
        var _this7 = this;
        this.update();
        var _t1 = function t(e) {
          _this7.render(e), requestAnimationFrame(_t1);
        };
        requestAnimationFrame(_t1);
      }
    }, {
      key: "startAnimation",
  ...
  var d = /*#__PURE__*/function (_l) {
    function d(t, e, i) {
      ...
      _this8 = _callSuper(this, d, [t, e]), _this8.canvas = i, _this8.ctx = i.getContext("2d");
      return _this8;
    }
    _inherits(d, _l);
    ...
    function p(t, e, i) {
      ...
      this.touchPoint = null, this.swipeTimeout = 250, this.onResize = function () {
        ...
        if (_this9.checkTarget(t.target)) {
          var _e0 = _this9.getMousePos(t.clientX, t.clientY);
          _this9.app.startUserTouch(_e0), t.preventDefault();
        }
      }, this.onTouchStart = function (t) {
        if (_this9.checkTarget(t.target) && t.changedTouches.length > 0) {
          var _e1 = t.changedTouches[0],
            _i9 = _this9.getMousePos(_e1.clientX, _e1.clientY);
          _this9.touchPoint = {
            point: _i9,
            time: Date.now()
          }, setTimeout(function () {
        ...
        if (t.changedTouches.length > 0) {
          var _e10 = t.changedTouches[0],
            _i0 = _this9.getMousePos(_e10.clientX, _e10.clientY);
          _this9.app.getSettings().mobileScrollSupport ? (null !== _this9.touchPoint && (Math.abs(_this9.touchPoint.point.x - _i0.x) > 10 || "read" !== _this9.app.getState()) && t.cancelable && _this9.app.userMove(_i0, !0), "read" !== _this9.app.getState() && t.preventDefault()) : _this9.app.userMove(_i0, !0);
        }
      }, this.onTouchEnd = function (t) {
        if (t.changedTouches.length > 0) {
          var _e11 = t.changedTouches[0],
            _i1 = _this9.getMousePos(_e11.clientX, _e11.clientY);
          var _s4 = !1;
          if (null !== _this9.touchPoint) {
            var _t10 = _i1.x - _this9.touchPoint.point.x,
              _e12 = Math.abs(_i1.y - _this9.touchPoint.point.y);
            Math.abs(_t10) > _this9.swipeDistance && _e12 < 2 * _this9.swipeDistance && Date.now() - _this9.touchPoint.time < _this9.swipeTimeout && (_t10 > 0 ? _this9.app.flipPrev(_this9.touchPoint.point.y < _this9.app.getRender().getRect().height / 2 ? "top" : "bottom") : _this9.app.flipNext(_this9.touchPoint.point.y < _this9.app.getRender().getRect().height / 2 ? "top" : "bottom"), _s4 = !0), _this9.touchPoint = null;
          }
          _this9.app.userStop(_i1, _s4);
        }
  ...
  var c = /*#__PURE__*/function (_p) {
    function c(t, e, i, s) {
      ...
      _this0 = _callSuper(this, c, [t, e, i]), _this0.wrapper.insertAdjacentHTML("afterbegin", '<div class="stf__block"></div>'), _this0.distElement = t.querySelector(".stf__block"), _this0.items = s;
      var _iterator6 = _createForOfIteratorHelper(s),
        _step6;
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          var _t11 = _step6.value;
          _this0.distElement.appendChild(_t11);
        }
      } catch (err) {
        _iterator6.e(err);
      } finally {
      ...
      value: function clear() {
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            this.parentElement.appendChild(_t12);
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
      ...
      value: function updateItems(t) {
        ...
        try {
          for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
            ...
            this.distElement.appendChild(_e13);
          }
        } catch (err) {
          _iterator8.e(err);
        } finally {
  ...
  var u = /*#__PURE__*/function (_p2) {
    function u(t, e, i) {
      ...
      _this1 = _callSuper(this, u, [t, e, i]), _this1.wrapper.innerHTML = '<canvas class="stf__canvas"></canvas>', _this1.canvas = t.querySelectorAll("canvas")[0], _this1.distElement = _this1.canvas, _this1.resizeCanvas(), _this1.setHandlers();
      return _this1;
    }
    _inherits(u, _p2);
  ...
  var w = /*#__PURE__*/function (_l2) {
    function w(t, e, i) {
      ...
      _this10 = _callSuper(this, w, [t, e]), _this10.outerShadow = null, _this10.innerShadow = null, _this10.hardShadow = null, _this10.hardInnerShadow = null, _this10.element = i, _this10.createShadows();
      return _this10;
    }
    _inherits(w, _l2);
    return _createClass(w, [{
      ...
      key: "clearShadow",
      value: function clearShadow() {
        _superPropGet(w, "clearShadow", this, 3)([]), this.outerShadow.style.cssText = "display: none", this.innerShadow.style.cssText = "display: none", this.hardShadow.style.cssText = "display: none", this.hardInnerShadow.style.cssText = "display: none";
      }
    }, {
      key: "reload",
      value: function reload() {
      ...
      value: function drawInnerShadow() {
        ...
        for (var _i10 = 0, _o2 = o; _i10 < _o2.length; _i10++) {
          ...
          _e14 = h.GetRotatedPoint(_e14, {
            x: i,
            y: 100
          }, r), a += _e14.x + "px " + _e14.y + "px, ";
        }
        a = a.slice(0, -2), a += ")";
      ...
      value: function drawOuterShadow() {
        ...
        var o = "polygon( ";
        for (var _i11 = 0, _r = r; _i11 < _r.length; _i11++) {
          var _t14 = _r[_i11];
          if (null !== _t14) {
            var _e15 = 1 === this.getDirection() ? {
            ...
            _e15 = h.GetRotatedPoint(_e15, {
              x: s,
              y: 100
            }, i), o += _e15.x + "px " + _e15.y + "px, ";
          }
        }
        o = o.slice(0, -2), o += ")";
      ...
      key: "update",
      value: function update() {
        _superPropGet(w, "update", this, 3)([]), null !== this.rightPage && this.rightPage.setOrientation(1), null !== this.leftPage && this.leftPage.setOrientation(0);
      }
    }]);
  }(l);
  ...
  t.PageFlip = /*#__PURE__*/function (_ref) {
    function _class(t, e) {
      ...
      _this11 = _callSuper(this, _class), _this11.isUserTouch = !1, _this11.isUserMove = !1, _this11.setting = null, _this11.pages = null, _this11.setting = new x().getSettings(e), _this11.block = t;
      return _this11;
    }
    ...
    return _createClass(_class, [{
      ...
      value: function loadFromImages(t) {
        ...
        this.render = new d(this, this.setting, e), this.flipController = new g(this.render, this), this.pages = new n(this, this.render, t), this.pages.load(), this.render.start(), this.pages.show(this.setting.startPage), setTimeout(function () {
          _this12.ui.update(), _this12.trigger("init", _this12, {
            page: _this12.setting.startPage,
            mode: _this12.render.getOrientation()
          });
        }, 1);
      }
    }, {
      ...
      value: function loadFromHTML(t) {
        ...
        this.ui = new c(this.block, this, this.setting, t), this.render = new w(this, this.setting, this.ui.getDistElement()), this.flipController = new g(this.render, this), this.pages = new o(this, this.render, this.ui.getDistElement(), t), this.pages.load(), this.render.start(), this.pages.show(this.setting.startPage), setTimeout(function () {
          _this13.ui.update(), _this13.trigger("init", _this13, {
            page: _this13.setting.startPage,
            mode: _this13.render.getOrientation()
          });
        }, 1);
      }
    }, {
    ...
    return _createClass(_class2, [{
      ...
      value: function trigger(t, e) {
        ...
        if (this.events.has(t)) {
          var _iterator0 = _createForOfIteratorHelper(this.events.get(t)),
            _step0;
          try {
            for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
              var _s5 = _step0.value;
              _s5({
                data: i,
                object: e
              });
